...
class HomePage {
    ...
    HomePage()
    {
        ...
        // HOME PAGE FRAME
        final JFrame homepageframe = new JFrame("XYZ Hospital");
        ...
        headerpanelsh.setBackground(new Color(100, 100, 200));            
        ...
        JLabel heading1 = new JLabel("XYZ HOSPITAL");
        ...
        username.setBounds(100,120,400,40);

        final JPasswordField password = new JPasswordField("Enter Password");
        password.setBounds(100,210,400,40);
